...
# 52
if(SD_Card_RWInit(0x00000000, 1, 0)) {
...
if(SD_Card_RWInit(0x00000200, 1, 0)) {
for(uint16_t i=0; i<512; i++) {
SD_SPI_Write(0xE1);
}
SD_Card_RWEnd();
...
# 71
if(SD_Card_RWInit(0x00000600, 1, 0)) {
uint32_t cardSize = SD_Card_GetSize();
uint8_t *p = (uint8_t *)&cardSize;
for(uint16_t i=512; i>0; i-=16) {
SD_SPI_Write(*(p + 3));
SD_SPI_Write(*(p + 2));
SD_SPI_Write(*(p + 1));
SD_SPI_Write(*p);
...
# 91
if(SD_Card_RWInit(0x00000800, 1, 0)) {
SD_SPI_Write(0x09);
...
uint16_t sum = 0;
if(SD_Card_RWInit(0x00000800, 0, 0)) {
for(uint16_t i=0; i<512; i++) {
sum += SD_SPI_Read();
}
SD_Card_RWEnd();
...
# 121
if(SD_Card_RWInit(0x00000A00, 1, 1)) {
...
# 142
if(SD_Card_RWInit(0x0000B000, 1, 1)) {
...
uint16_t sum2 = 0;
if(SD_Card_RWInit(0x0000B200, 0, 1)) {
